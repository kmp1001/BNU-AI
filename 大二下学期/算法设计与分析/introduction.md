...
- **期末考试**：  
  ...
  - 最优二叉查找树（明确占 10 分）；
  - 分支限界法与回溯法（明确必考，需掌握核心思想、两者联系与区别，字句不需死记硬背，理解要点即可）
  - 霍夫曼树（可能作为三大计算题之一，需掌握构造方法，与数据结构课程类似
  - 最短路径
  - 最小生成树
  - 霍夫曼树
  - 简单排序（插入排序、选择排序）：题目较简单，可能出两道，每题 5 分。
  - 高级排序（快速排序或其他分治排序）：出 1 道，占 10 分。
  - 俄式乘法
  - 大整数乘法
  - 二进制乘法（自左到右、自右到左，占 5 分）
  - 最后一章的“超越算法能力极限”分界线部分也会涉及。

- **录入成绩**：  
  - 2024 录入速度较快。课程最高分：97
  - 2025 录入成绩较慢。
